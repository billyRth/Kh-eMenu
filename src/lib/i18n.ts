...
const STRINGS = {
  ...
  s_guests: { en: 'Guests', km: 'ភ្ញៀវ', zh: '客人' },
  s_guestsSub: { en: '{n} tables · {amt} per guest', km: 'តុ {n} · {amt} ក្នុងម្នាក់', zh: '{n} 桌 · 人均 {amt}' },
  s_guestsNone: { en: 'Seat tables to count guests', km: 'ដាក់ភ្ញៀវតាមតុ ដើម្បីរាប់ភ្ញៀវ', zh: '安排入座后才会统计人数' },
